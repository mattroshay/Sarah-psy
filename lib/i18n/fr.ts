...
const fr: Dictionary = {
  ...
  home: {
    ...
    testimonials: [
      {
        quote:
          "J'ai été accompagnée par Sarah à travers des approches à la fois TCC et psychodynamiques, et cette expérience s'est révélée extrêmement précieuse. Sarah possède une remarquable capacité à allier compréhension en profondeur et stratégies pratiques, ce qui a eu un réel impact positif sur mon quotidien. J'ai véritablement le sentiment d'avoir acquis un nouveau regard sur moi-même et sur le monde qui m'entoure. Je la recommande vivement à toute personne à la recherche d'une thérapeute réfléchie, compétente et bienveillante.",
        fullQuote:
          "J'ai travaillé avec Sarah en utilisant à la fois des approches TCC et psychodynamiques, et cette expérience a été extrêmement enrichissante. Bien que toutes nos séances aient eu lieu en visioconférence, j'ai ressenti les mêmes bénéfices et la même qualité de relation que lors d'une thérapie en présentiel. Ensemble, nous avons exploré mon anxiété, mon estime de moi et ma confiance en moi. Sarah m'a aidée à comprendre à la fois les racines profondes de ces difficultés et les moyens concrets de les gérer au quotidien. Elle a une remarquable capacité à associer compréhension en profondeur et outils pratiques, ce qui a eu un réel impact positif sur ma vie de tous les jours. Sarah est une excellente thérapeute : à l'écoute, empathique, bienveillante et très compétente dans son domaine. Elle s'appuie sur différentes approches et théories psychologiques qu'elle explique avec clarté, ce qui permet de mieux comprendre son fonctionnement et de donner du sens à ses expériences personnelles. En dehors des séances, Sarah fait preuve de souplesse et de disponibilité, et cherche toujours à trouver des créneaux qui conviennent à chacun. Depuis le début de mon accompagnement avec Sarah, j'ai beaucoup progressé dans mon développement personnel. J'ai véritablement acquis un nouveau regard sur moi-même et sur le monde qui m'entoure. Je la recommande chaleureusement à toute personne à la recherche d'une thérapeute compétente, réfléchie et profondément humaine.",
        attribution: "Lucy",
      ...
      },
      {
        ...
        fullQuote:
          "J'avais déjà consulté plusieurs thérapeutes auparavant, mais je ne m'étais jamais sentie suffisamment à l'aise pour m'ouvrir pleinement, notamment en raison de différences culturelles, de croyances ou de valeurs personnelles. Avec Sarah, l'expérience a été différente. Son bilinguisme et sa compréhension à la fois des perspectives arabes et occidentales lui permettent de créer un espace sécurisant et équilibré, où l'on se sent réellement compris plutôt que jugé. Elle prend le temps de comprendre qui vous êtes, votre parcours et ce qui compte réellement pour vous. Son approche est douce, pertinente et souvent révélatrice, en particulier pour les femmes qui portent de lourdes charges émotionnelles tout en se sentant parfois incomprises ou jugées. Elle m'a aidée à traverser des difficultés personnelles et familiales importantes d'une manière à la fois soutenante et valorisante. J'apprécie énormément son professionnalisme, sa bienveillance et sa capacité à rendre la thérapie accessible et rassurante. Je retournerais la consulter sans hésiter et je la recommande vivement à toute personne à la recherche d'une thérapeute alliant compassion, sensibilité interculturelle et conseils concrets.",
        attribution: "Patiente anonyme",
      },
      {
        quote:
          "Sarah allie une solide expertise professionnelle et une grande expérience à une compassion authentique et une véritable présence humaine. Elle aide non seulement ses patients à traverser leurs difficultés, mais crée également un espace où ils se sentent réellement vus, entendus et compris. C'est sans doute son plus grand atout, et une qualité qui reste profondément irremplaçable.",
        fullQuote:
    ...
    testimonialsViewOnGoogle: "Voir sur Google",
    testimonialsCloseLabel: "Fermer",
